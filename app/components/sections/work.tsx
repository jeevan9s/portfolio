  ...
  return (
    ...
    >
      <div className="flex flex-col justify-start p-8 pt-10 md:sticky md:top-0 md:h-screen md:overflow-hidden md:p-12 md:pt-10 xl:p-16 2xl:p-20">
        ...
        <div ref={scrollHostRef} className="w-full snap-x snap-proximity overflow-x-auto touch-pan-x overflow-y-visible md:overflow-hidden md:snap-none md:touch-auto">
          <div
            ref={trackRef}
