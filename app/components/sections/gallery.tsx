...
const photos: Photo[] = [
  ...
  { id: "4", src: "/gallery/img_04.jpg?v=2", alt: "Gallery image 4", orientation: "portrait" },
  { id: "5", src: "/gallery/img_05.jpg?v=2", alt: "Gallery image 5", orientation: "portrait" },
...
function GalleryCard({
  ...
  return (
    <motion.div
      ...
      data-cursor="grow"
      className={`relative mb-0 inline-block w-full break-inside-avoid ${aspectClass[photo.orientation]} overflow-hidden bg-[#2A2A2A] [content-visibility:auto]`}
    >
      <Image
        src={photo.src}
        alt={photo.alt}
