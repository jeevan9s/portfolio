...
export default function Navbar({ currPage }: navbarProps) {
  ...
  return (
    <div className="flex flex-row nav-theme-bg fixed top-0 left-0 right-0 w-screen z-50 items-center justify-between px-6 py-4 transition-colors duration-300">
